...
export async function run(provider: NetworkProvider) {
    ...
    const stakingPool = provider.open(StakingPool.createFromAddress(Address.parse("0QAe5ut01jSjYg3dPuLQFsyKnzPhQkd0LHNFlBtm4E4uKkD8")));
    let stakingPoolConfig = await stakingPool.getStorageData();
    stakingPoolConfig.maxDeposit = 50000n * (10n ** 9n)
